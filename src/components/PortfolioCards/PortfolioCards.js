    ...
    <div className='row'>
      <Card style={{margin: '40px 0 80px 60px'}} className='Cardbackground'>
        ...
        <Card.Body>
          ...
          <br />
          <div className='row'>
            <Project src1='/img/BonAPPvoyage.png' alt1='bonAPPvoyage site' title1='BonAPPvoyage' description1='A cooking and traveling webiste mixed in one. This site uses both the triposo and spoonacular API. The user search for recipes based on cooking time. Which, then the user can click on the type of cuisine for each recipe to see places of interest related to the cuisine.' repository1='https://github.com/UofTbootcampgroupproject/bonAPPvoyage'
